...
# Title: Lab1
# Author: Brayan_celis_Miller_gamba_L1C_G3
...
class lab1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._fc_range = Range(100, 50000, 10, 1500, 200)
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/labcom/Documentos/LabComL1CG3_Brayan_MIller/rebelion_joearroyo.wav-20230412T200459Z-001/rebelion_joearroyo.wav', True)
